    ...
    <div className="space-y-4">
        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`animate-fade-in-up stagger-${index + 1} text-left px-4 py-3 rounded-lg border transition-all duration-200 ${
                hasText ? "" : "flex-1"
      ...
      {!resultMode && (
        <button
          ...
          className={`w-full py-3 px-6 bg-[var(--accent)] text-white font-medium rounded-lg hover:bg-[var(--accent-hover)] hover:scale-[1.01] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
